...
export default function FlashCard({
  ...
  return (
    <li data-identifier="flashcard">
      ...
      <CardAberto respondendo={respondendo} finalizada={questao.resultado} data-identifier="flashcard-index-item">
        <Frente onClick={() => setVirada(true)} virada={virada} data-identifier="flashcard-question">
          <p>{questao.pergunta}</p>
          <img src={setinha} alt="seta para ver a resposta" data-identifier="flashcard-turn-btn"/>
        </Frente>
        <Verso virada={virada} data-identifier="flashcard-answer">
          <p>{questao.resposta}</p>
          <ContainerBotoes>
            <Botao cor="#FF3030" onClick={() => concluir(cardAtual, "nl")} data-identifier="forgot-btn">
              Não
              <br /> lembrei
            </Botao>
            <Botao cor="#FF922E" onClick={() => concluir(cardAtual, "qnl")} data-identifier="almost-forgot-btn">
              Quase Não
              <br /> lembrei
            </Botao>
            <Botao cor="#2FBE34" onClick={() => concluir(cardAtual, "zap")} data-identifier="zap-btn">
              Zap!
            </Botao>
          </ContainerBotoes>
        </Verso>
...
const IconErro = (
  <svg data-identifier="flashcard-status" viewBox="0 0 512 512" fill="red">
...
const IconZap = (
  <svg data-identifier="flashcard-status" viewBox="0 0 512 512" fill="green">
    <path d="M256 48C141.31 48 48 141.31 48 256s93.31 208 208 208 208-93.31 208-208S370.69 48 256 48zm108.25 138.29l-134.4 160a16 16 0 01-12 5.71h-.27a16 16 0 01-11.89-5.3l-57.6-64a16 16 0 1123.78-21.4l45.29 50.32 122.59-145.91a16 16 0 0124.5 20.58z" />
  </svg>
);

const IconDuvida = (
  <svg data-identifier="flashcard-status" viewBox="0 0 512 512" fill="orange">
